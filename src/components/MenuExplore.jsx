        ...
        {menu_list.map((item, index) => {
          return (
            <div
              ...
              className={`flex h-[98px] w-[60px] cursor-pointer flex-col items-center justify-between rounded-full ${category === item.menu_name ? "bg-orange text-white" : "bg-white"} p-1 transition-all`}
            >
