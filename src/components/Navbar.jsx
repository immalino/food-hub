      ...
      <ul className="flex h-full w-full items-center justify-around">
        ...
        <li>
          ...
          >
            ...
            />
            <div
              className={`absolute -top-2 left-8 ${totalItemInCart >= 1 ? "flex" : "hidden"} h-4 w-max items-center justify-center rounded-md bg-orange px-1 py-1 text-xs font-medium text-white`}
            >
              {totalItemInCart}
            </div>
          </NavLink>
